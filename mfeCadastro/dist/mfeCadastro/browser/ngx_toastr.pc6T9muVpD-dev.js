...
import { Directive, InjectionToken, inject, Injectable, ComponentFactoryResolver, ApplicationRef as ApplicationRef2, SecurityContext, Injector as Injector2, Inject, signal, Component, ChangeDetectionStrategy, HostBinding, HostListener, makeEnvironmentProviders, NgModule } from "@angular/core";
...
var ToastContainerDirective = class _ToastContainerDirective {
    ...
    static ɵfac = function ToastContainerDirective_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _ToastContainerDirective)(i0.ɵɵdirectiveInject(i0.ElementRef));
    };
...
var Overlay = class _Overlay {
    ...
    _appRef = inject(ApplicationRef2);
    _document = inject(DOCUMENT);
...
var ToastrService = class _ToastrService {
    ...
    _buildNotification(toastType, message, title, config) {
        ...
        const toastInjector = Injector2.create({
            providers,
    ...
    static ɵfac = function ToastrService_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _ToastrService)(i0.ɵɵinject(TOAST_CONFIG), i0.ɵɵinject(Overlay), i0.ɵɵinject(i0.Injector), i0.ɵɵinject(i2.DomSanitizer), i0.ɵɵinject(i0.NgZone));
    };
    static ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
var Toast = class _Toast {
    ...
    static ɵfac = function Toast_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _Toast)(i0.ɵɵdirectiveInject(ToastrService), i0.ɵɵdirectiveInject(ToastPackage), i0.ɵɵdirectiveInject(i0.NgZone));
    };
...
var ToastNoAnimation = class _ToastNoAnimation {
    ...
    static ɵfac = function ToastNoAnimation_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _ToastNoAnimation)(i0.ɵɵdirectiveInject(ToastrService), i0.ɵɵdirectiveInject(ToastPackage), i0.ɵɵdirectiveInject(i0.ApplicationRef));
    };
    static ɵcmp = /* @__PURE__ */ i0.ɵɵdefineComponent({
